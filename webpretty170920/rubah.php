...
<?php
	echo "<table width=\"100%\" border=\"0\">
			...
			<tr>
				<td align=\"center\" style=\"font-family: Tahoma, Calibri; font-size:13px; font-style: normal; color:#006666; font-weight:				  	 			normal\"><br><br><h2>Form Perubahan Kata Sandi</h2><br>
				<table width=\"100%\" >
					<tr>
					<td width =\"10%\">
					</td>
			...
			echo	"</td>
					...
					<tr>
						<td align=\"left\">
						<button type=\"submit\" class=\"cancelbtn1\">Ganti Kata Sandi</button>
						</td>
					</tr>
					</table>
					</form>
