...
<script>startsplash('mybanner',4,5000);</script><style>
	...
	echo "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">
			...
			<table width=\"100%\">
				...
				<td width =\"80%\">
					...
					//<?php
									...
									$qlogo = "select location from xxprtitmmap where no = 102 and tipe = 'banner'";
			...
			<tr>
				...
				<tr>
					...
					<td width=\"80%\"><br><img src=\"workfolder/linelimit20.jpg\"/>
					</td>
					<td width=\"10%\">
					</td>
				</tr>
				...
				<td width=\"10%\">";
				//$kata = "cantik";
				//echo "<a href = \"detil.php?id=$kata\"/>click</a>";
		        echo "</td>
				<td width=\"80%\" style=\"font-family: Tahoma, Calibri; font-size:13px; font-style: normal; color:#006666; font-weight: normal\">
					...
					$query = "select * from xxprtitmmap where tipe like 'aksesoris'";
					...
					while ($row = mysql_fetch_array ($hasil))
					{
						...
						echo "<a href = \"detil.php?id=$item\" style = \"text-decoration:none;color:#006666\"/>$nama<br>Rp. $row[price],-</a><br><br>		  						</td>
						<td></td>";
					}
		 echo "	</tr>
		 		</table>
