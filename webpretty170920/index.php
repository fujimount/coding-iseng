...
<script>startsplash('mybanner',6,6000);</script>
<style>
...
<?php
	echo "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">
					...
					<table class=\"table\" id=\"myHeader\" width =\"100%\" bgcolor=\"#F2F1F1\">
					  ...
					  echo "</td>
							<td width = \"40%\" valign=\"middle\">
								...
								<input name=\"kata\" type=\"text\" placeholder =\"Search...\" id=\"text-input\">
			...
			<table width=\"100%\">
				...
				<td id=\"responsive\" width=\"80%\">
					<table id=\"responsive\" width=\"100%\">
					<tr>
					<td id=\"responsive\" align=\"center\" width = \"100%\" valign=\"middle\">
					<!--<div id =\"mybanner\" class=\"responsive\" style=\"height:350px; width:850px; vertical-align:middle;\">
						...
						<img id=\"mybanner0\" src=\"workfolder/bannerimg14.jpg\"/>
						<img id=\"mybanner1\" src=\"workfolder/bannerimg12.jpg\"/>-->
					<div id=\"responsive\" align=\"center\">
						<img align=\"middle\" src=\"workfolder/bannerimg14.jpg\" id=\"responsive\"/>
					</div>
					</td>
					</tr>
					</table>
			...
			<tr>
				...
				<tr>
					...
					<td width=\"80%\"><br><img src=\"workfolder/linelimit16.jpg\"/>
					</td>
					<td width=\"10%\">
					</td>
				</tr>
				...
				<td width=\"80%\" style=\"font-family: Tahoma, Calibri; font-size:13px; font-style: normal; color:#006666; font-weight: normal\">
					...
					$query = "select * from xxprtitmmap where tipe like '%home1' and nohal = 5";
					...
					while ($row = mysql_fetch_array ($hasil))
					{
						...
						echo "<td align=\"center\" valign=\"middle\" width=\"260\" height=\"360\" background=\"backgrd3.jpg\">
									<img src= \"$row[location]\" id=\"contain\" width=\"200\" height=\"250\" align=\"middle\"/>
							  <br><br>";
						...
						echo "<a href = \"x3tas.php\" style = \"text-decoration:none; color:#006666\"/>$nama</a><br><br></td>
						<td></td>";
					}
		 echo "	</tr>
		 		</table>
		       ...
		       echo "</td>
					...
					$query = "select * from xxprtitmmap where tipe like '%home'";
					...
					while ($row = mysql_fetch_array ($hasil))
					{
						...
						echo "<a href = \"x1pakai.php\" style = \"text-decoration:none; color:#006666\"/>$nama</a><br><br></td>
						<td></td>";
					}
		  echo "</tr>
		 		</table>
				...
				<tr>
					...
					<td width=\"80%\"><br><img src=\"workfolder/linelimit22.jpg\"/>
					</td>
					<td width=\"10%\">
					</td>
				</tr>
		       ...
		       echo "</td>
					...
					$query = "select * from xxprtitmmap where tipe like 'img'";
					...
					while ($row = mysql_fetch_array ($hasil))
					{
						...
						echo "<td align=\"center\" valign=\"middle\">
								<img src= \"$row[location]\" id=\"contain\" width=\"230\" height=\"300\" align=\"middle\"/>";
