	...
	echo "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">
			...
			<table width=\"100%\">
				...
				<td width =\"80%\">
					...
					//<?php
									...
									$qlogo = "select location from xxprtitmmap where no = 94 and tipe = 'banner'";
			...
			<tr>
				...
				<tr>
					...
					<td width=\"80%\"><br><img src=\"workfolder/linelimit18.jpg\"/>
					</td>
					<td width=\"10%\">
					</td>
				</tr>
				...
				<td width=\"80%\" style=\"font-family: Tahoma, Calibri; font-size:13px; font-style: normal; color:#006666; font-weight: normal\">
					...
					$query = "select * from xxprtitmmap where tipe like 'pakaian%'";
